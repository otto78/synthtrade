...
# Avvia backend (porta 8000) e frontend (porta 4201) in finestre separate
...
Start-Process powershell -ArgumentList "-NoExit", "-Command", `
  "Set-ExecutionPolicy -Scope Process -ExecutionPolicy RemoteSigned; & '$venv'; cd '$backend'; uvicorn app.main:app --reload --port 8000" `
  -WindowStyle Normal
